...
import './pastel-img.css'


function Pastel_img({url}){
    ...
    return(
        <>
            <img className='pastel-img'  src={url ? url : default_img}></img>
            <div className='pastel-img__wrapper'></div>
        </>           
    )
}

export default Pastel_img