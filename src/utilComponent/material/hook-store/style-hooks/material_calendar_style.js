...
import { startOfDay, isBefore, isWithinInterval, isAfter} from "date-fns";

function useMaterialCalendarStyle(data, states, refs, props){

    // =================================================
    // states //
    const {is_left_button,
           setIs_left_button,
           is_right_button,
           setIs_right_button} = states

    // =================================================
    // refs //
    const {header_slider_ref,
           main_slider_ref,
           left_button_ref,
           right_button_ref,
           calendar_container_ref} = refs

    // =================================================
    // props //
    const {set_checkout_handler,
           set_checkin_handler,
           checkin_date,
           checkout_date} = props
    ...
    function click_prev_month(){  
        ...
        if(container_scroll_width === container_width * 4){
