...
function Det_sec3({data}){
    
    console.log(data)

    return(
        <div className="Det_sec3-container">
            <div className="Det_sec3-nodata"  style={{display:`${data ? 'none' : 'block'}`}}>
            ...
            <div className="Det_sec3-sec1"  style={{display:`${data ? 'block' : 'none'}`}}>
                <div className="Det_sec3-s1-b1">
                    <div className="Det_sec3-s1-b1-d1">평점</div>
            ...
            <div className="Det_sec3-sec2"></div>
        </div>
    )
}
