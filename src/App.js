...
import { 
        ...
        Acc_regist, Acc_initial ,Acc_regist_lv1, Acc_manage,Acc_regist_lv0, 
        Acc_regist_lv2, Acc_regist_lv3,Acc_regist_lv4, Acc_regist_lv5
        ,Acc_regist_lv6,Acc_regist_lv7,Acc_regist_lv8,Acc_regist_lv9,
        Acc_regist_lv10,Acc_regist_lv11,Acc_regist_lv12, Acc_regist_start,Evaluation,
        Acc_regist_intro,Acc_initial_regist,

        Private_history,Private_management,ReservationApp, Private_point,
    ...
    <Provider store = {store}>
      <div className="App">
        ...
        <Routes>            
          ...
          <Route exact path='/Profile' element={<Private_router data_state={true} element={Profile} />}></Route>                                        ///프로필 이미지 + 닉네임 등록
          <Route exact path='Join_complete' element = {<Private_router data_state={true} element={Join_complete}/>}></Route>                            ///회원가입 완료
          ...
          {/* // =================================================
              // 숙소 상세 페이지 // */}
          <Route exact path='/SubApp/Detail_info' element={<Detail_info></Detail_info>}>                                                                ///숙소 상세페이지
            <Route exact path=':house' element={<Detail_info></Detail_info>}></Route>
          </Route>

          {/* // =================================================
              // 호스트 페이지 // */}
          <Route exact path='/Acc_regist' element={<Conditional_router data_state={true}                                              
          ...
          <Route exact path='/Acc_initial_regist' element={<Private_router data_state={true} element={Acc_initial_regist}></Private_router>}></Route>    ///초기 호스트 정보 기입 페이지    
