            ...
            <div className="lv4-des-con-wrapper">
                ...
                <div className="lv4-description-wrapper">
                    <div className="lv4-content-gurabox">
                        {/* left */}
                        <Lslide_btn  direction={true} btnState={LbtnState} moveSlide = {moveLslide} distance={1182} left={left}></Lslide_btn>
                        {/* right */}
                        <Rslide_btn  direction={false} btnState={RbtnState} moveSlide = {moveRSlide} distance={1182}></Rslide_btn>
                    </div>
