            ...
            <div className="login__content">
                <form 
                    ...
                    <div className="login__section">
                        ...
                        <input 
                            type="text" 
                            placeholder="bohyeongzzang123" 
                            className={`login__userid ${errors.id ? 'input-invalid' : ''}`}
                            {...register('id')} 
                    ...
                    <div className="login__section">
                        ...
                        <input 
                            ...
                            className={`login__userpassword ${errors.password ? 'input-invalid' : ''}`}
                            {...register('password')} 
                            autoComplete="off"></input>
                    ...
                    <div className="login__state">
                        <img 
                            className= {`login__state-img ${log_method ? 'login__active' : ''}`} 
                            onClick={click_login_method}
                    ...
                    <input 
                        className={`login__button ${isValid ? 'button-enable' : 'button-disable'}`} 
                        disabled={!isValid} 
                        type="submit" 
                        value="로그인"/>
                </form>
